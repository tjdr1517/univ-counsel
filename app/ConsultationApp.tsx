  ...
  return <div className="app-shell">
    ...
    <main className="main-panel">
      ...
      <div className="page-wrap">
        ...
        {view === "interests" && <InterestsPage user={user} students={data.students} interests={interests} onNew={() => setInterestModal(true)} />}
